...
async function createAccount(){
  ...
  if(!first_name||!last_name||!phone||!email||password.length<12||password.length>72){setMsg('INSERISCI NOME, COGNOME, TELEFONO VALIDO E PASSWORD TRA 12 E 72 CARATTERI',true);return}
